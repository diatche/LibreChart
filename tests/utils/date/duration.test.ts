...
describe('duration', () => {
    ...
    describe('addUniformMs', () => {
        it('should add positive time', () => {
            ...
            expect(
                addUniformMs(date, kDateUnitUniformMs['second']).format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:01');
            expect(
                addUniformMs(date, kDateUnitUniformMs['minute']).format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:01:00');
            expect(
                addUniformMs(date, kDateUnitUniformMs['hour']).format(
                    kDateFormat
                )
            ).toBe('2020-01-01 01:00:00');
            expect(
                addUniformMs(date, kDateUnitUniformMs['day']).format(
                    kDateFormat
                )
            ).toBe('2020-01-02 00:00:00');
            expect(
                addUniformMs(date, kDateUnitUniformMs['month']).format(
                    kDateFormat
                )
            ).toBe('2020-02-01 00:00:00');
            expect(
                addUniformMs(date, kDateUnitUniformMs['year']).format(
                    kDateFormat
                )
        ...
        it('should add positive partial time', () => {
            let date = moment('2020-01-01');
            expect(
                addUniformMs(date, kDateUnitUniformMs['day'] / 2).format(
                    kDateFormat
                )
            ).toBe('2020-01-01 12:00:00');

            expect(
                addUniformMs(date, kDateUnitUniformMs['day'] * 29).format(
                    kDateFormat
                )
            ).toBe('2020-01-30 00:00:00');
            expect(
                addUniformMs(date, kDateUnitUniformMs['day'] * 30).format(
                    kDateFormat
                )
            ).toBe('2020-02-01 00:00:00');
            expect(
                addUniformMs(date, kDateUnitUniformMs['day'] * 31).format(
                    kDateFormat
                )
            ).toBe('2020-02-02 00:00:00');

            expect(
                addUniformMs(date, kDateUnitUniformMs['month'] * 13).format(
                    kDateFormat
                )
            ).toBe('2021-02-01 00:00:00');
        });
    ...
    describe('interpolatedDate', () => {
        it('should return corrent date', () => {
            ...
            ).toBe(moment('2020-01-05').toISOString());
            ...
            ).toBe(moment('2020-01-06').toISOString());
            ...
            ).toBe(moment('2020-01-05 12:00').toISOString());
            ...
            ).toBe(moment('2020-01-04').toISOString());
        });
        ...
        it('should change UTC offset accross DST', () => {
            ...
            expect(interpolatedDate(start, end, 0).utcOffset()).toBe(
                start.utcOffset()
            );
            expect(interpolatedDate(start, end, 1).utcOffset()).toBe(
                end.utcOffset()
            );
        });
    });
    ...
    describe('roundDate', () => {
        ...
        it('should round date to same value with 1 millisecond', () => {
            expect(
                roundDate(moment.unix(0.001), 1, 'millisecond').valueOf()
            ).toBe(1);
        });

        it('should round date up from middle with 2 millisecond', () => {
            expect(
                roundDate(moment.unix(0.001), 2, 'millisecond').valueOf()
            ).toBe(2);
        });
        ...
        it('should round date down with 1 hour', () => {
            expect(
                roundDate(moment('2020-01-08T00:29'), 1, 'hour').format(
                    kDateFormat
                )
            ).toBe('2020-01-08 00:00:00');
        });

        it('should round date up from middle with 1 hour', () => {
            expect(
                roundDate(moment('2020-01-08T00:30'), 1, 'hour').format(
                    kDateFormat
                )
            ).toBe('2020-01-08 01:00:00');
        });

        it('should round date down with 2 hour', () => {
            expect(
                roundDate(moment('2020-01-08T00:59'), 2, 'hour').format(
                    kDateFormat
                )
            ).toBe('2020-01-08 00:00:00');
        });
        ...
        it('should round date up from middle with 2 hour', () => {
            expect(
                roundDate(moment('2020-01-08T01:00'), 2, 'hour').format(
                    kDateFormat
                )
            ).toBe('2020-01-08 02:00:00');
        });
        ...
        it('should round date down with 1 day', () => {
            expect(
                roundDate(moment('2020-01-01T11:59'), 1, 'day').format(
                    kDateFormat
                )
        ...
        it('should round date down with 1 day with postive time zone', () => {
            ...
            expect(roundedDate.format(kDateFormat)).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should round date up from middle with 1 day', () => {
            expect(
                roundDate(moment('2020-01-01T12:00'), 1, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-02 00:00:00');
        });
        ...
        it('should round date up with 1 day with positive time zone', () => {
            ...
            let roundedDate = roundDate(date, 1, 'day');
            expect(roundedDate.utcOffset()).toBe(120);
            expect(roundedDate.format(kDateFormat)).toBe('2020-01-02 00:00:00');
        });
        ...
        it('should round to same date on boundary with 1 day', () => {
            expect(
                roundDate(moment('2020-01-02'), 1, 'day').format(kDateFormat)
            ).toBe('2020-01-02 00:00:00');
        });

        it('should round date down with 2 day', () => {
            expect(
                roundDate(moment('2020-01-01T23:59'), 2, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should round date up from middle with 2 day', () => {
            expect(
                roundDate(moment('2020-01-02T00:00'), 2, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-03 00:00:00');
        });

        it('should use specified origin date', () => {
            expect(
                roundDate(moment('2019-11-18'), 5, 'day', {
                    originDate: moment('2020-01-01'),
                }).format(kDateFormat)
            ).toBe('2019-11-17 00:00:00');
        ...
        it('should return same date on edge with 1 month (31 days)', () => {
            expect(
                roundDate(moment('2020-01-01'), 1, 'month').format(kDateFormat)
            ).toBe('2020-01-01 00:00:00');
        });

        it('should round date down with 1 month (31 days)', () => {
            expect(
                roundDate(moment('2020-01-15'), 1, 'month').format(kDateFormat)
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should round date up from middle with 1 month (31 days)', () => {
            expect(
                roundDate(moment('2020-01-17'), 1, 'month').format(kDateFormat)
            ).toBe('2020-02-01 00:00:00');
        });
        ...
        it('should round date up with 1 month (31 days) with postive time zone', () => {
            ...
            let roundedDate = roundDate(date, 1, 'month');
            expect(roundedDate.utcOffset()).toBe(120);
            expect(roundedDate.format(kDateFormat)).toBe('2020-02-01 00:00:00');
        });
        ...
        it('should return same date on edge with 1 month (30 days) accross DST', () => {
            expect(moment('2020-04-01T00:00').utcOffset()).not.toEqual(
                moment('2020-05-01T00:00').utcOffset()
            );
            expect(
                roundDate(moment('2020-04-01T00:00'), 1, 'month').format(
                    kDateFormat
                )
        ...
        it('should round date down with 1 month (30 days) accross DST', () => {
            ...
            expect(
                roundDate(moment('2020-04-15T11:59'), 1, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-04-01 00:00:00');
        });
        ...
        it('should round date up with 1 month (30 days) accross DST', () => {
            ...
            expect(
                roundDate(moment('2020-04-17'), 1, 'month').format(kDateFormat)
            ).toBe('2020-05-01 00:00:00');
        });

        it('should round date down with 2 month', () => {
            expect(
                roundDate(moment('2020-01-29T23:59'), 2, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should round date up from middle with 2 month', () => {
            expect(
                roundDate(moment('2020-02-01T00:00'), 2, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-03-01 00:00:00');
        });
        ...
        it('should round old date down with 1 years', () => {
            expect(
                roundDate(moment('1900-06-01'), 1, 'year').format(kDateFormat)
            ).toBe('1900-01-01 00:00:00');
        });

        it('should round old date up from middle with 1 years', () => {
            expect(
                roundDate(moment('1900-07-01'), 1, 'year').format(kDateFormat)
            ).toBe('1901-01-01 00:00:00');
        });

        it('should round old date down with 10 years', () => {
            expect(
                roundDate(moment('1904-01-01'), 10, 'year').format(kDateFormat)
            ).toBe('1900-01-01 00:00:00');
        });

        it('should round old date up from middle with 10 years', () => {
            expect(
                roundDate(moment('1905-01-01'), 10, 'year').format(kDateFormat)
            ).toBe('1910-01-01 00:00:00');
        });
    ...
    describe('floorDate', () => {
        ...
        it('should floor date down with 1 day', () => {
            expect(
                floorDate(moment('2020-01-01T11:59'), 1, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should floor date down from middle with 1 day', () => {
            expect(
                floorDate(moment('2020-01-01T12:00'), 1, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should floor same date on boundary with 1 day', () => {
            expect(
                floorDate(moment('2020-01-02'), 1, 'day').format(kDateFormat)
            ).toBe('2020-01-02 00:00:00');
        });

        it('should floor date down with 2 day', () => {
            expect(
                floorDate(moment('2020-01-01T23:59'), 2, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should floor date down from middle with 2 day', () => {
            expect(
                floorDate(moment('2020-01-02T00:00'), 2, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should floor date down with 1 month (31 days)', () => {
            expect(
                floorDate(moment('2020-01-16T11:59'), 1, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should floor date down from middle with 1 month (31 days)', () => {
            expect(
                floorDate(moment('2020-01-16T12:00'), 1, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should floor date down with 2 month', () => {
            expect(
                floorDate(moment('2020-01-31T23:59'), 2, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
        ...
        it('should floor date down from middle with 2 month', () => {
            expect(
                floorDate(moment('2020-02-01T00:00'), 2, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-01-01 00:00:00');
        });
    ...
    describe('ceilDate', () => {
        ...
        it('should ceil date up with 1 day', () => {
            expect(
                ceilDate(moment('2020-01-01T11:59'), 1, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-02 00:00:00');
        });
        ...
        it('should ceil date up from middle with 1 day', () => {
            expect(
                ceilDate(moment('2020-01-01T12:00'), 1, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-02 00:00:00');
        });
        ...
        it('should ceil same date on boundary with 1 day', () => {
            expect(
                ceilDate(moment('2020-01-02'), 1, 'day').format(kDateFormat)
            ).toBe('2020-01-02 00:00:00');
        });

        it('should ceil date up with 2 day', () => {
            expect(
                ceilDate(moment('2020-01-01T23:59'), 2, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-03 00:00:00');
        });
        ...
        it('should ceil date up from middle with 2 day', () => {
            expect(
                ceilDate(moment('2020-01-02T00:00'), 2, 'day').format(
                    kDateFormat
                )
            ).toBe('2020-01-03 00:00:00');
        });
        ...
        it('should ceil same date on boundary with 2 day', () => {
            expect(
                ceilDate(moment('2020-01-03'), 2, 'day').format(kDateFormat)
            ).toBe('2020-01-03 00:00:00');
        });
        ...
        it('should ceil date up with 1 month (31 days)', () => {
            expect(
                ceilDate(moment('2020-01-16T11:59'), 1, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-02-01 00:00:00');
        });
        ...
        it('should ceil date up from middle with 1 month (31 days)', () => {
            expect(
                ceilDate(moment('2020-01-16T12:00'), 1, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-02-01 00:00:00');
        });
        ...
        it('should ceil date up with 2 month', () => {
            expect(
                ceilDate(moment('2020-01-31T23:59'), 2, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-03-01 00:00:00');
        });
        ...
        it('should ceil date up from middle with 2 month', () => {
            expect(
                ceilDate(moment('2020-02-01T00:00'), 2, 'month').format(
                    kDateFormat
                )
            ).toBe('2020-03-01 00:00:00');
        });
    ...
    describe('dateUnitsWithDuration', () => {
        it('should convert valid durations', () => {
            expect(dateUnitsWithDuration(moment.duration(0))).toEqual([
                0,
                'millisecond',
            ]);
            expect(dateUnitsWithDuration(moment.duration(2))).toEqual([
                2,
                'millisecond',
            ]);
            expect(dateUnitsWithDuration(moment.duration(2, 'ms'))).toEqual([
                2,
                'millisecond',
            ]);
            ...
            expect(dateUnitsWithDuration(moment.duration(2, 'day'))).toEqual([
                2,
                'day',
            ]);
            expect(dateUnitsWithDuration(moment.duration(2, 'month'))).toEqual([
                2,
                'month',
            ]);
            expect(dateUnitsWithDuration(moment.duration(2, 'year'))).toEqual([
                2,
                'year',
            ]);
        });
